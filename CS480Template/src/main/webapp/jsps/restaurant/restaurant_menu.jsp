...
<html>
  ...
  <body>
	...
	<a href="<c:url value='/jsps/restaurant/restaurant_update.jsp'/>" target="_parent">Update Restaurant</a> |&nbsp;	 
	<a href="<c:url value='/jsps/restaurant/restaurant_delete.jsp'/>" target="_parent">Delete Restaurant</a>	
