...
public class EmployeeServletUpdate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(method.equals("search"))
		{
			...
			if(employee.getEmployee_contact()!=null){
		...
		else if(method.equals("update"))
		{
			...
			form.setEmployee_join_date(java.sql.Date.valueOf(request.getParameter("employee_join_date")));
			form.setEmployee_contact(request.getParameter("employee_contact"));	
		
			try {
				System.out.println("updated employee form");
